...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	[QBSettings setAccountKey:@"vUD7KXrKD6PqzXWWbYWq"];
    ...
    videoChatConfiguration[kQBVideoChatCallTimeout] = @20;
    videoChatConfiguration[kQBVideoChatFrameQualityPreset] = AVCaptureSessionPresetLow;
    videoChatConfiguration[kQBVideoChatVideoFramesPerSecond] = @2;
    videoChatConfiguration[kQBVideoChatP2PTimeout] = @3;
